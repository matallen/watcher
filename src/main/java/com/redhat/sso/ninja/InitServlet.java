...
//    Backup.start(TimeUnit.DAYS.toMillis(1), Database2.STORAGE.getAbsolutePath());
    
    
    Backup.start(TimeUnit.HOURS.toMillis(Long.parseLong(Config.get().getOptions().get("intervalInHours"))));
  }
